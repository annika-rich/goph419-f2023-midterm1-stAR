...
def main():
    ...
    #compute determinant of K1 to see if system has a unique soluiton
    ...
    K2 = k * K1 # Multiply entire matrix by k to determine true displacemnts
